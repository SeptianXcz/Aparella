...
"fileName": `Aparella-BOT ${ngazap(prefix)}`,
...
https://chat.whatsapp.com/JNTFdpKBDSz4Lecu6vNZcq`)
break
case 'infoupdate':
reply('-')
break
...
fs.writeFileSync('./database/menfess.json', JSON.stringify(db_menfes))
var tulis_pesan = `✉️𝗖𝗵𝗮𝘁 𝗔𝗻𝗼𝗻𝘆𝗺𝗼𝘂𝘀 𝗧𝗲𝗿𝗵𝘂𝗯𝘂𝗻𝗴✉️
